...
MoreStereoEditor::MoreStereoEditor(MoreStereoProcessor& p)
    : AudioProcessorEditor(&p), audioProcessor(p),
      presetBar(p.getValueTreeState(), "HyperPrism Reimagined More Stereo", "MoreStereo"), enhancedStereoMeter(p)
{
    ...
    widthSlider.setDescription("Overall stereo width enhancement");
    bassMonoSlider.setTooltip("Makes low frequencies mono for tighter bass");
    bassMonoSlider.setDescription("Makes low frequencies mono for tighter bass");
    crossoverFreqSlider.setTooltip("Frequency that separates bass and treble processing");
    crossoverFreqSlider.setDescription("Frequency that separates bass and treble processing");
    stereoEnhanceSlider.setTooltip("Enhances existing stereo differences in the treble");
    stereoEnhanceSlider.setDescription("Enhances existing stereo differences in the treble");
    ambienceSlider.setTooltip("Adds subtle reverb-based spaciousness");
    ambienceSlider.setDescription("Adds subtle reverb-based spaciousness");
...
void MoreStereoEditor::paintOverChildren(juce::Graphics& g)
{
