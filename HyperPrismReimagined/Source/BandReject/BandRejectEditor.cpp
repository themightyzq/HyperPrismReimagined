...
BandRejectEditor::BandRejectEditor(BandRejectProcessor& p)
    : AudioProcessorEditor(&p), audioProcessor(p),
      presetBar(p.getValueTreeState(), "HyperPrism Reimagined Band-Reject Filter", "BandReject")
{
    ...
    centerFreqSlider.setDescription("Center frequency of the rejected (notch) band");
    qSlider.setTooltip("Narrowness of the notch -- higher Q means a tighter cut");
    qSlider.setDescription("Narrowness of the notch -- higher Q means a tighter cut");
    gainSlider.setTooltip("Boost or cut the overall signal level");
    gainSlider.setDescription("Boost or cut the overall signal level");
...
void BandRejectEditor::paintOverChildren(juce::Graphics& g)
{
