//==============================================================================
// HyperPrism Reimagined - Band-Reject Filter Editor
...
// Main Editor
//==============================================================================
class BandRejectEditor : public juce::AudioProcessorEditor
{
public:
    BandRejectEditor(BandRejectProcessor&);
    ~BandRejectEditor() override;
...
private:
    ...
    BandRejectProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BandRejectEditor)
};