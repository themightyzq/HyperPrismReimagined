...
PhaserEditor::PhaserEditor(PhaserProcessor& p)
    : AudioProcessorEditor(&p), audioProcessor(p),
      presetBar(p.getValueTreeState(), "HyperPrism Reimagined Phaser", "Phaser")
{
    ...
    rateSlider.setDescription("Speed of the phaser sweep");
    depthSlider.setTooltip("Intensity of the phaser modulation");
    depthSlider.setDescription("Intensity of the phaser modulation");
    feedbackSlider.setTooltip("Resonance — creates a more pronounced swept sound");
    feedbackSlider.setDescription("Resonance — creates a more pronounced swept sound");
    stagesSlider.setTooltip("Number of allpass stages — more stages means deeper phasing");
    stagesSlider.setDescription("Number of allpass stages — more stages means deeper phasing");
...
void PhaserEditor::paintOverChildren(juce::Graphics& g)
{
