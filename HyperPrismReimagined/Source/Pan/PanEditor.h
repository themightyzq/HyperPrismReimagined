...
//==============================================================================
// Pan meter - shows L/R levels and pan position
//==============================================================================
class PanMeter : public juce::Component, private juce::Timer
{
public:
    explicit PanMeter(PanProcessor& processor);
    ~PanMeter() override;
...
private:
    ...
    PanProcessor& processor;
    float leftLevel = 0.0f;
    float rightLevel = 0.0f;
    float panPosition = 0.0f;
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PanMeter)
};
