//==============================================================================
// HyperPrism Reimagined - Delay Editor
...
private:
    ...
    ParameterLabel stereoOffsetLabel;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> stereoOffsetAttachment;
