      ...
      presetBar(p.getValueTreeState(), "HyperPrism Reimagined Chorus", "Chorus")
{
    ...
    rateSlider.setDescription("Speed of the chorus modulation");
    depthSlider.setTooltip("Intensity of the pitch variation");
    depthSlider.setDescription("Intensity of the pitch variation");
    delaySlider.setTooltip("Base delay time for the chorus voices");
    delaySlider.setDescription("Base delay time for the chorus voices");
    feedbackSlider.setTooltip("Amount of signal fed back into the delay for richer sound");
    feedbackSlider.setDescription("Amount of signal fed back into the delay for richer sound");
    lowCutSlider.setTooltip("Remove low frequencies from the chorus effect");
    lowCutSlider.setDescription("Remove low frequencies from the chorus effect");
    highCutSlider.setTooltip("Remove high frequencies from the chorus effect");
    highCutSlider.setDescription("Remove high frequencies from the chorus effect");
    mixSlider.setTooltip("Balance between dry and chorus signal");
    mixSlider.setDescription("Balance between dry and chorus signal");
...
void ChorusEditor::paintOverChildren(juce::Graphics& g)
{
