...
LimiterEditor::LimiterEditor(LimiterProcessor& p)
    : AudioProcessorEditor(&p), audioProcessor(p),
      presetBar(p.getValueTreeState(), "HyperPrism Reimagined Limiter", "Limiter"), gainReductionMeter(p)
{
    ...
    ceilingSlider.setDescription("Maximum output level -- signal will not exceed this");
    releaseSlider.setTooltip("How quickly the limiter releases after catching a peak");
    releaseSlider.setDescription("How quickly the limiter releases after catching a peak");
    lookaheadSlider.setTooltip("Look ahead time to catch transients before they clip");
    lookaheadSlider.setDescription("Look ahead time to catch transients before they clip");
    inputGainSlider.setTooltip("Boost input signal to drive the limiter harder");
    inputGainSlider.setDescription("Boost input signal to drive the limiter harder");
...
void LimiterEditor::paintOverChildren(juce::Graphics& g)
{
