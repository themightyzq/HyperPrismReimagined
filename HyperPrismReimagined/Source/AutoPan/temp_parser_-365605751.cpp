...
// Minimal JUCE declarations for parsing
namespace juce {
    // Basic types
    class String {};
    class Colour {};
    ...
    class Line { public: Point start, end; };
    ...
    public: 
        ...
        void setRange(double min, double max, double step = 0) {} 
        void setValue(double value) {}
        void setSliderStyle(SliderStyle style) {}
        void setTextBoxStyle(TextEntryBoxPosition pos, bool isReadOnly, int textBoxWidth) {}
    ...
    public: 
        void setText(const String& text, NotificationType notification) {} 
        void setText(const char* text, NotificationType notification) {} 
    ...
    public: 
        ...
        void setReturnKeyStartsNewLine(bool returnKey) {}
        void setText(const String& text) {}
        void setReadOnly(bool readOnly) {}
        void setScrollbarsShown(bool showScrollbars) {}
    };
    
    class ComboBox : public Component { 
    public: 
        void addItem(const String& text, int itemId) {} 
    ...
    public: 
        ...
        void setTextLabelPosition(int position) {}
    };
    
    // Additional UI components often found in commercial projects
    class DrawableButton : public TextButton {};
    class ImageButton : public TextButton {};
    class HyperlinkButton : public TextButton {};
    class ArrowButton : public TextButton {};
    ...
    // Audio-related components common in JUCE projects
    class AudioVisualiserComponent : public Component {};
    class AudioDeviceSelectorComponent : public Component {};
    class AudioThumbnail {};
    class MidiKeyboardComponent : public Component {};
    
    // Common namespaces in JUCE projects
    namespace dsp {}
    namespace midi {}
}

// Common std types used in JUCE
namespace std {
