//==============================================================================
// HyperPrism Reimagined - HyperPhaser Editor
...
// Main Editor
//==============================================================================
class HyperPhaserEditor : public juce::AudioProcessorEditor
{
public:
    HyperPhaserEditor(HyperPhaserProcessor&);
    ~HyperPhaserEditor() override;
...
private:
    ...
    HyperPhaserProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(HyperPhaserEditor)
};