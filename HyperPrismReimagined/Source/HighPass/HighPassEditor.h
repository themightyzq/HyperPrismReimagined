//==============================================================================
// HyperPrism Reimagined - High-Pass Filter Editor
...
// Main Editor
//==============================================================================
class HighPassEditor : public juce::AudioProcessorEditor
{
public:
    HighPassEditor(HighPassProcessor&);
    ~HighPassEditor() override;
...
private:
    ...
    HighPassProcessor& audioProcessor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(HighPassEditor)
};