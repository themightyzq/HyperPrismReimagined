//==============================================================================
// HyperPrism Revived - Single Delay Editor
...
//==============================================================================
// Delay meter - shows I/O levels and delay visualization
//==============================================================================
class DelayMeter : public juce::Component, private juce::Timer
{
public:
    explicit DelayMeter(SingleDelayProcessor& processor);
    ~DelayMeter() override;
...
private:
    ...
    SingleDelayProcessor& processor;
    float inputLevel = 0.0f;
    float outputLevel = 0.0f;
    std::vector<float> delayBuffer;
    int bufferPosition = 0;
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(DelayMeter)
};

//==============================================================================
// Main Editor
//==============================================================================
class SingleDelayEditor : public juce::AudioProcessorEditor
{
public:
    SingleDelayEditor(SingleDelayProcessor&);
    ~SingleDelayEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SingleDelayEditor)
};